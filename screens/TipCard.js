...
export default class TipCard extends Component {
  constructor(props) {
    ...
    this.state = {
      fontsLoaded: false,
      light_theme: true,
      tip_id: this.props.tip.key,
      tip_data: this.props.tip.value,
      is_liked: false,
      likes: this.props.tip.value.likes
    };
  }
  ...
  likeAction = () => {
    // console.log("this.state.tip_id",this.state.tip_id)
    if (this.state.is_liked) {
      firebase
        .database()
        .ref("posts")
        .child(this.state.tip_id)
        .child("likes")
    ...
    if (!this.state.fontsLoaded) {
      ...
      return (
        ...
        >
          ...
          >
            <Image
              source={images[tip.preview_image]}
